...
_EnumSet_ - это одна из специализированных реализаций интерфейса [_Set_](Set) для использования с [типом перечисления](Enum). Вот несколько важных особенностей _EnumSet_:
