...
Класс Java File, java.io.File в Java IO API предоставляет вам доступ к базовой файловой системе. Используя класс Java File, вы можете: 
