...
В качестве альтернативы мы также можем использовать `psvm` и нажмите кнопку Tab для автоматического заполнения `public static void main(String[] args)`.
...
| <font color=lightgreen>Shift + F6</font> | <font color=lightgreen>Переименовать</font> |
