...
| 4   | **[[ScannerClass#Метод findInLine() - выполняет поиск следующего вхождения указанного шаблона в текущей строке ввода\|String findInLine(Pattern pattern)]]**<br>Этот метод пытается найти следующее вхождение указанного шаблона, игнорируя разделители.                                                                                                                                                                                                                                                                                                  |
| 5   | **[[ScannerClass#Метод findWithinHorizon(String pattern, int horizon) - выполняет поиск следующего появления указанного шаблона во входных данных до указанного горизонта\|String findWithinHorizon(Pattern pattern, int horizon)]]**<br>Этот метод пытается найти следующее вхождение указанного шаблона.                                                                                                                                                                                                                                                |
...
| 7   | **[[ScannerClass#Метод hasNextBigDecimal() - возвращает true, если во входных данных присутствует другой токен, и он может быть интерпретирован как BigDecimal\|boolean hasNextBigDecimal()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как [BigDecimal](BigDecimal) с помощью метода [[ScannerClass#Метод nextBigDecimal() - возвращает следующий токен во входных данных в виде BigDecimal\|nextBigDecimal()]].                                                                  |
| 8   | **[[ScannerClass#Метод hasNextBigInteger() - возвращает true, если во входных данных присутствует другой токен, и он может быть интерпретирован как BigInteger\|boolean hasNextBigInteger()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как [BigInteger](BigInteger) в базе данных по умолчанию с использованием метода [[ScannerClass#Метод nextBigInteger() - возвращает следующий токен во входных данных как [BigInteger](BigInteger)\|nextBigInteger()]].                     |
| 9   | **[[ScannerClass#Метод hasNextBoolean() - возвращает true, если у сканера есть другой логический токен\|boolean hasNextBoolean()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как логическое значение с использованием шаблона без учета регистра, созданного из строки "true \| false".                                                                                                                                                                                            |
| 10  | **[[ScannerClass#Метод byte nextByte() - возвращает следующий токен во входных данных в виде байта\|boolean hasNextByte()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как байтовое значение в базе данных по умолчанию с помощью метода [[ScannerClass#Метод byte nextByte() - возвращает следующий токен во входных данных в виде байта\|nextByte()]].                                                                                                                            |
| 11  | **[[ScannerClass#Метод hasNextDouble() - возвращает true, если во входных данных присутствует другой токен, и он может быть интерпретирован как double\|boolean hasNextDouble()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как двойное значение с помощью метода [[ScannerClass#Метод Double nextDouble() - возвращает следующий токен во входных данных как double\|nextDouble()]].                                                                                              |
| 12  | **[[ScannerClass#Метод hasNextFloat() - возвращает true, если во входных данных присутствует другой токен, который может быть интерпретирован как значение с плавающей точкой\|boolean hasNextFloat()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как значение с плавающей точкой с помощью метода [[ScannerClass#Метод float nextFloat() - возвращает следующий токен во входных данных в виде числа с плавающей точкой\|nextFloat()]].                                           |
| 13  | **[[ScannerClass#Метод hasNextInt() - возвращает true, если во входных данных присутствует другой токен, и он может быть интерпретирован как int\|boolean hasNextInt()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как значение int в базе данных по умолчанию с помощью метода [[ScannerClass#Метод nextInt() in Java- возвращает следующий токен во входных данных как int\|nextInt()]].                                                                                         |
...
| 15  | **[[ScannerClass#Метод hasNextLong() - возвращает true, если во входных данных присутствует другой токен, который может быть интерпретирован как long\|boolean hasNextLong()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как длинное значение в базе данных по умолчанию с помощью метода [[ScannerClass#Метод long nextLong() - возвращает следующий токен во входных данных как long\|nextLong()]].                                                                              |
| 16  | **[[ScannerClass#Метод hasNextShort - возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как короткое значение в базе данных по умолчанию с использованием nextShort() метода.\|boolean hasNextShort()]]**<br>Этот метод возвращает true, если следующий токен во входных данных этого сканера может быть интерпретирован как короткое значение в базе данных по умолчанию с помощью метода [[ScannerClass#Метод short nextShort() - возвращает следующий токен во входных данных как short\|nextShort()]]. |
| 17  | **[[ScannerClass#Метод ioException() - возвращает исключение IOException, последнее вызванное базовым Readable сканера\|IOException ioException()]]**<br>Этот метод возвращает исключение [IOException](Exceptions), последнее вызванное базовым Readable этого сканера.                                                                                                                                                                                                                                                                                  |
...
| 21  | **[[ScannerClass#Метод nextBigDecimal() - возвращает следующий токен во входных данных в виде BigDecimal\|BigDecimal nextBigDecimal()]]**<br>Этот метод сканирует следующий токен входных данных как [BigDecimal](BigDecimal).                                                                                                                                                                                                                                                                                                                            |
...
| 40  | **[[ScannerClass#Метод hasNextPattern() - возвращает true, если следующий токен во входных данных соответствует указанному шаблону\|boolean hasNextPattern()]]**                                                                                                Возвращает true, если следующий токен во входных данных соответствует указанному шаблону.                                                                                                                                                                                                 |
|     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
**Вывод:**
<p style="background-color: navy; color: yellow">Mean: 3</p>
